...
void S_Lobby::set_exit_button()
{
    ...
    exit_button->collide_image.Name = "Image/Button/Lobby/exit";
...
void S_Lobby::set_start_button()
{
    ...
    start_button->activated_image.Name = "Image/Button/Lobby/start";
    ...
    start_button->collide_image.Name = "Image/Button/Lobby/start_active";
